用Math.floor(Math.random() *xxx)做的效果；和生成随机数的套路是差不多的；
```javascript
...
<head>
    ...
    <style>
        ...
        #div2{width:900px;height:150px;background: orange;text-align:center;padding: 20px;border-radius: 5px;position: absolute;left:50%;top:50%;margin: -75px 0 0 -450px;}
        #div1{height:100px;line-height:100px;}
...
<body>
<div class="broszhu">
    <h3 id="home_top">随机实现名人名言　-　Powered By
